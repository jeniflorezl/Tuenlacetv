    ...
    describe 'POST create' do
      ...
      it 'ok create manual bill' do
        headers = { 
          ...
          "Accept" => "application/json",
          "Authorization" => "Bearer 57f58b86dd567bd33a309a1234bc73e9"}
        post "http://localhost:3000/api/v1/facturacion/factura_manual/PRUEBAS", :params => '{ "tipo_facturacion_id": 1, "servicio_id": 2, "f_elaboracion": "01/03/2018", "f_inicio": "01/03/2018", "f_fin": "30/03/2018", "entidad_id": 7, "valor": 25000, "observa": "MENSUALIDAD MARZO", "usuario_id": 1, "db": "PRUEBAS" }', :headers => headers
        expect(response).to have_http_status(:ok)
      end
