    ...
    describe 'DELETE delete' do
      ...
      it 'it is not ok if it is foreign key' do
        headers = { 
          ...
          "Accept" => "application/json",
          "Authorization" => "Bearer 57f58b86dd567bd33a309a1234bc73e9"}
        delete "http://localhost:3000/api/v1/senales/5", :headers => headers
