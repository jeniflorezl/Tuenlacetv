...
RSpec.describe Senal, :type => :model do
  it "is valid with a entity, contract, address, urbanization,
  tower, apartment, neighborhood, zone, phones, contact, stratum, type living place,
  observation, contract date, permanence, amount tv, amount decoder, precinto, 
  seller, type of installation, technology, type of service, installation area, user,
  billing type" do
    senal = Senal.new(entidad_id: 1, contrato: '4789963', direccion: 'Calle 11 #24-23', 
    urbanizacion: '', torre: '', apto: '', barrio_id: 1, zona_id: 1, telefono1: '4540312', 
    telefono2: '', contacto: '', estrato: '4', vivienda: 'P', observacion: '', 
    fechacontrato: '01/01/2017', permanencia: '', televisores: 2, decos: '', precinto: '12321', 
    vendedor_id: 5, tipo_instalacion_id: 1, tecnologia_id: 1, tiposervicio: 'residencial', 
