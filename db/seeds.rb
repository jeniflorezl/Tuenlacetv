...
Documento.create(nombre: 'NOTA CRÉDITO TELEVISIÓN', abreviatura: 'CRT', clase: 'P', usuario_id: 1)
Documento.create(nombre: 'NOTA CRÉDITO INTERNET', abreviatura: 'CRT', clase: 'P', usuario_id: 1)
...
Documento.create(nombre: 'DESCUENTOS TELEVISIÓN', abreviatura: 'DCT', clase: 'P', usuario_id: 1)
Documento.create(nombre: 'DESCUENTOS INTERNET', abreviatura: 'DCT', clase: 'P', usuario_id: 1)
