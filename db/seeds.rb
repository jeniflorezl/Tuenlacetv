...
Estado.create(nombre: 'PENDIENTE', abreviatura: 'PE', usuario: 'admin')
Estado.create(nombre: 'ANULADO', abreviatura: 'AN', usuario: 'admin')
Estado.create(nombre: 'APLICADO', abreviatura: 'AP', usuario: 'admin')
Estado.create(nombre: 'PAGADO', abreviatura: 'PA', usuario: 'admin')
=end
