...
ActiveSupport::Inflector.inflections do |inflect|
    ...
    inflect.irregular 'tipo_instalacion', 'tipo_instalaciones'
    ...
    inflect.irregular 'direccion_dian', 'direcciones_dian'
    inflect.irregular 'DireccionDian', 'DireccionesDian'
    inflect.irregular 'dir_correspondencia', 'dir_correspondencia'
    inflect.irregular 'DirCorrespondencia', 'DirCorrespondencia'
    inflect.irregular 'plantilla_fact', 'plantilla_fact'
    inflect.irregular 'PlantillaFact', 'PlantillaFact'
    inflect.irregular 'facturacion', 'facturacion'
    inflect.irregular 'Facturacion', 'Facturacion'
    inflect.irregular 'detalle_factura', 'detalle_factura'
    inflect.irregular 'DetalleFactura', 'DetalleFactura'
    inflect.irregular 'detalle_orden', 'detalle_orden'
    inflect.irregular 'DetalleOrden', 'DetalleOrden'
    inflect.irregular 'factura_orden', 'factura_orden'
    inflect.irregular 'FacturaOrden', 'FacturaOrden'
    inflect.irregular 'registro_orden', 'registro_orden'
    inflect.irregular 'RegistroOrden', 'RegistroOrden'
    inflect.irregular 'mvto_rorden', 'mvto_rorden'
    inflect.irregular 'MvtoRorden', 'MvtoRorden'
    inflect.irregular 'historial_tarifa', 'historial_tarifas'
